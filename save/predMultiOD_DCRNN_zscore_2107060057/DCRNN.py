...
class DCRNN(nn.Module):
    ...
    def forward(self, x_seq: torch.Tensor):
        ...
        # encoding
        _, h_t_lst = self.encoder(P=self.P, x_seq=x_seq, h_0_l=None)  # encoder returns layerwise last hidden state [(B, N, C)] * L
        # decoding
...
def main():
    from Param import ADJPATH, TIMESTEP_IN, TIMESTEP_OUT
